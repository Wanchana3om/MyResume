function Footer(props) {
  return (
    <section
      className={`py-10 bg-gradient-to-l ${
        props.light
          ? "from-[#dbd2fe] to-[#6a88ff]"
          : "from-[#0e0e0e] to-[#223b35]"
      } font-[300] text-[14px]  `}
    >
      <div
        className={`xl:flex lg:flex ${
          props.light ? "text-black" : "text-white"
        } justify-between ml-[15%] mr-[15%] block`}
      >
        <div className="xl:w-[30%] lg:w-[30%]">
          <h1 className="text-[20px] font-semibold">Address</h1>
          <div
            className={`w-[90px] mb-5 mt-2 h-[5px] ${
              props.light ? "bg-[#ffc897]" : "bg-[#76f9c5]"
            }`}
          ></div>
          <p className="font-[300] pt-3 text-[14px]">
            Wangchala, Wangnoi,
            <br /> Ayutthaya 13170
          </p>
        </div>
        <div className="xl:w-[30%] lg:w-[30%] xl:mt-0 lg:mt-0 mt-8">
          ...
          <div
            className={`w-[120px] mb-5 mt-2 h-[5px] ${
              props.light ? "bg-[#ffc897]" : "bg-[#76f9c5]"
            }`}
          ></div>
          ...
          <div className="flex justify-start items-center">
            ...
            <div>
              <a
                className={`${
                  props.light ? "hover:text-[#ad5100]" : "hover:text-[#518ef8]"
          ...
          <div className="flex justify-start items-center">
            ...
            <div>
              <a
                ...
                href="https://web.facebook.com/wanchanaa.ang/"
                target="_blank"
              >
